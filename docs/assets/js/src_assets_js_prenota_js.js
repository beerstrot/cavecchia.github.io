...
function updateShifts(dp, selected, people) {
  ...
  (0,_utils__WEBPACK_IMPORTED_MODULE_0__.mkCall)('POST', {
    ...
    if (shifts_.length === 0) return showMessage("<p>In questa data siamo chiusi.</p><p>Per richieste puoi scriverci in chat ".concat(whatsAppString, ".</p><p>Grazie</p>"));
...
function showReservation(pid) {
  ...
  (0,_utils__WEBPACK_IMPORTED_MODULE_0__.mkCall)('POST', {
    ...
    if (res.booking === null) {
      $('#yes').hide();
      $('#no').hide();
      return showConsultaMessage('Prenotazione non trovata.', "Se non hai cancellato la prenotazione in precedenza, puoi scriverci in chat ".concat(whatsAppString, " o chiamarci al numero ").concat(telString, " per chiarimenti."));
    }
...
var whatsAppString = '<a href="https://api.whatsapp.com/send?phone=390718853384" class="highlight" target="_blank"><i class="lab la-whatsapp">&thinsp;Whatsapp</i></a>';
var message10 = "Seleziona il numero di persone";
